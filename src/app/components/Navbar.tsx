    ...
    >
      ...
      >
        <Link href="#home" className="py-2 text-4xl whitespace-nowrap mr-1 ">
          <h1 className={`${greatVibes.className} text-white -mb-2`}>
            Fabiola <span className={`text-[#B76E78]`}>&</span>Jonathan
          </h1>
        </Link>
        <button
          type="button"
          onClick={() => setOpen(!open)}
          className="lg:hidden border-2 border-gray-300 px-2 py-1"
        >
      ...
      <motion.div
        ...
        } lg:flex  w-full justify-center items-start lg:items-center pl-4 bg-[rgba(207,207,207,1)] lg:bg-transparent lg:transition-none transition-all duration-300 ease-out z-[-1]`}
      >
        <motion.div
          initial={{
            x: -500,
        ...
        >
          <Link
            ...
            className={`uppercase ${
              section === "home" ? "text-[#B76E78]" : "text-white"
          ...
          <Link
            ...
            onClick={() => setOpen(false)}
            className={`uppercase ${
              section === "about" ? "text-[#B76E78]" : "text-white"
            }  font-semibold py-3 px-2.5 `}
          >
            About
          </Link>
          <Link
            ...
            onClick={() => setOpen(false)}
            className={`uppercase ${
              section === "story" ? "text-[#B76E78]" : "text-white"
            }  font-semibold py-3 px-2.5 `}
          >
            Story
          </Link>
          <Link
            ...
            onClick={() => setOpen(false)}
            className={`uppercase ${
              section === "gallery" ? "text-[#B76E78]" : "text-white"
            }  font-semibold py-3 px-2.5 `}
          >
            Gallery
          </Link>
        ...
        >
          <Link
            href="#home"
            className="py-2 text-4xl whitespace-nowrap mx-10  hidden lg:block"
          >
            <h1 className={`${greatVibes.className} text-white -mb-2`}>
              Fabiola <span className={`text-[#B76E78]`}>&</span>Jonathan
            </h1>
        ...
        >
          ...
          <Link
            ...
            onClick={() => setOpen(false)}
            className={`uppercase ${
              section === "event" ? "text-[#B76E78]" : "text-white"
            }  font-semibold py-3 px-2.5 `}
          >
            Event
          </Link>
          <Link
            ...
            onClick={() => setOpen(false)}
            className={`uppercase ${
              section === "rsvp" ? "text-[#B76E78]" : "text-white"
            }  font-semibold py-3 px-2.5 `}
          >
            RSVP
          </Link>
          <Link
            ...
            onClick={() => setOpen(false)}
            className={`uppercase ${
              section === "contact" ? "text-[#B76E78]" : "text-white"
            }  font-semibold py-3 px-2.5 `}
          >
            Contact
          </Link>
