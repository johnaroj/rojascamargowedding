...
function Footer({}: Props) {
  return (
    <section className="mb-4 py-20 flex flex-col justify-center items-center bg-[rgba(207,207,207,1)]">
      <h1
        className={`${greatVibes.className} text-7xl text-center py-10 text-white`}
      >
        Thank You for being a part of our new beginning
      </h1>
      <div className="flex items-center justify-center space-x-5 my-4 pb-10">
      ...
      <p className="m-0 text-center">
        ©{" "}
        <a className="text-[#B76E78]" href="info@rojascamargowedding.info">
          RojasCamargowedding
        </a>{" "}
        Designed by{" "}
        <a className="text-[#B76E78]" href="https://www.iamjohnrojas.com/">
          DVLP
        </a>
      </p>
    </section>
