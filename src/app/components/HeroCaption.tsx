...
function HeroCaption({ }: Props) {
    return (
        <>
            <div
                className="absolute inset-0 flex flex-col items-center justify-center text-white text-4xl font-bold z-20 space-y-6 text-center"
            >
                <motion.h1
                    initial={{
                        scale: 2,
                    ...
                    className={`${greatVibes.className} text-6xl lg:text-8xl  font-bold`}>Fabiola & Jonathan</motion.h1>
                <motion.div
                    initial={{
                        opacity: 0,
                    }}
