    ...
    return (
        <div className='flex flex-col max-w-6xl px-10 pt-10 mx-auto items-center'>
            <div className="mb-4 pt-20 flex flex-col justify-center items-center">
                <h6 className="uppercase text-[#B76E78] text-md mb-3 font-semibold tracking-widest">Story</h6>
                    ...
                    stories.map((story) => (
                        ...
                        '>
                            ...
                            <div className='relative aspect-[4/3] md:w-1/2'>
                                <Image alt={story.title} src={story.image} sizes="100vh" fill style={{ objectFit: 'cover' }} />
                            </div>
